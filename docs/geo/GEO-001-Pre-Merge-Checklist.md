...
- [ ] `npm run beta:test`
- [ ] `npm run geo:readiness-check`
- [ ] `NEXT_PUBLIC_SITE_URL=https://judao.club npm run build`

CI 使用 Node 22，并只授予 `contents: read`。在该文件推送到 PR #10 head 后，push/synchronize 应触发 Actions；只有 GitHub 页面显示全部成功，才能勾选以上项目。
