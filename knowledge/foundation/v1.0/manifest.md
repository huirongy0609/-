...
| JD009 | 《什么是开放式预算？》 | `approved` | —（原件已取得） | `knowledge/foundation/v1.0/jd/jd009-what-is-open-budget.md`；来源附件`7f8abed3-25c3-460d-96d0-e305877ffc7c/pasted-text.txt` | V1.0 | 项目总架构师于2026-07-14确认JD009已完成Architecture Review AR-008并批准正式入库 | 已入库；正文冻结，后续修订另建版本 |

## 入库结论

- `approved`：7项（JD001—JD006、JD009），均已完成正式入库。
- `draft`：2项（JD007、JD008），均未进入正式库。
- `in_review`：0项。
...
| JD009 | `jd/jd009-what-is-open-budget.md` | `7e6b59e667039da50afdf33ff38f7e8b7b61de3e6160ff7fd1c0e47c4ba5de71` |
...
JD009批准附件整体SHA-256：`7e6b59e667039da50afdf33ff38f7e8b7b61de3e6160ff7fd1c0e47c4ba5de71`。Foundation正式文件与附件原始字节一致；生命周期、批准事实和入库状态由本Manifest、Audit及机器索引登记，不回写冻结正文。
...
| JD009 | JD005、JD006、JD007、JD008 | GT-B07、GT-B08（Pending Reference；尚未进入Foundation，不推定批准状态） |
