...
function candidateObject(input: ParsedCandidateInput): Omit<KnowledgeObject, "relationships"> & {
  ...
  return {
    ...
    definition: metadataString(attributes, "definition", "one_line_definition", "一句话定义"),
    ...
    chapter: metadataString(attributes, "chapter", "chapter_name", "所属章节"),
    legal_basis: metadataList(attributes, "legal_basis", "legalBasis", "法律依据"),
    published_at: metadataString(attributes, "published_at", "publishedAt", "发布日期"),
    questions: metadataList(attributes, "questions", "Questions", "question_mapping", "用户问题"),
    source,
